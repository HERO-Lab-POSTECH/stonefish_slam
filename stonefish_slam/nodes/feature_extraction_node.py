...
class FeatureExtractionNode(Node):
    ...
    def __init__(self):
        ...
        # CFAR parameters (defaults match config/slam.yaml: CFAR.*)
        ...
        # Filter parameters (defaults match config/slam.yaml: filter.*)
        ...
        # Visualization parameters (defaults match config/slam.yaml: visualization.*)
