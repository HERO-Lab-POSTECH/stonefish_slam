...
# import rospy  # ROS2: Not needed, use print or pass logger
...
def loginfo(msg):
    if offline:
        ...
        print(f"[INFO] {msg}")  # ROS2: Use print
...
def logdebug(msg):
    if offline:
        ...
        print(f"[DEBUG] {msg}")  # ROS2: Use print
...
def logwarn(msg):
    if offline:
        ...
        print(f"[WARN] {msg}")  # ROS2: Use print
...
def logerror(msg):
    if offline:
        ...
        print(f"[ERROR] {msg}")  # ROS2: Use print
